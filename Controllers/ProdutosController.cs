...
namespace EmpresaWZ.CadastroPedido.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProdutoId,NomeProduto")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProdutoId,NomeProduto")] Produto produto)
        {
            if (ModelState.IsValid)
            {
